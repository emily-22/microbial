...
awBreak_avgs[[12]]  <- lm( Breakdown~ scale(Temp) + scale(SRP), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[13]]  <- lm( Breakdown~ scale(Temp) + scale(Nitrate), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[14]]  <- lm( Breakdown~ scale(Temp) + scale(Ammonium), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[15]]  <- lm( Breakdown~ scale(Temp) + scale(Chloride), data=woodbdnoAMD, REML = FALSE)

awBreak_avgs[[16]]  <- lm( Breakdown~ scale(Chloride) + scale(SRP), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[17]]  <- lm( Breakdown~ scale(Chloride) + scale(Nitrate), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[18]]  <- lm( Breakdown~ scale(Chloride) + scale(Ammonium), data=woodbdnoAMD, REML = FALSE)

awBreak_avgs[[19]]  <- lm( Breakdown~ scale(Nitrate) + scale(SRP), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[20]]  <- lm( Breakdown~ scale(Nitrate) + scale(Ammonium), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[21]]  <- lm( Breakdown~ scale(SRP) + scale(Ammonium), data=woodbdnoAMD, REML = FALSE)

awBreak_avgs[[22]]  <- lm( Breakdown~ scale(Turbidity) + scale(H), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[23]]  <- lm( Breakdown~ scale(Turbidity) + scale(DO), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[24]]  <- lm( Breakdown~ scale(Turbidity) + scale(Temp), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[25]]  <- lm( Breakdown~ scale(Turbidity) + scale(Chloride), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[26]]  <- lm( Breakdown~ scale(Turbidity) + scale(SRP), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[27]]  <- lm( Breakdown~ scale(Turbidity) + scale(Nitrate), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[28]]  <- lm( Breakdown~ scale(Turbidity) + scale(Ammonium), data=woodbdnoAMD, REML = FALSE)

awBreak_avgs[[29]]  <- lm( Breakdown~ scale(DO) + scale (H), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[30]]  <- lm( Breakdown~ scale(DO) + scale(Temp), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[31]]  <- lm( Breakdown~ scale(DO) + scale(Chloride), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[32]]  <- lm( Breakdown~ scale(DO) + scale(SRP), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[33]]  <- lm( Breakdown~ scale(DO) + scale(Nitrate), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[34]]  <- lm( Breakdown~ scale(DO) + scale(Ammonium), data=woodbdnoAMD, REML = FALSE)

awBreak_avgs[[35]]  <- lm( Breakdown~ scale(H) + scale(Chloride), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[36]]  <- lm( Breakdown~ scale(H) + scale(Nitrate), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[37]]  <- lm( Breakdown~ scale(H) + scale(Ammonium), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[38]]  <- lm( Breakdown~ scale(H) + scale(SRP), data=woodbdnoAMD, REML = FALSE)
awBreak_avgs[[39]]  <- lm( Breakdown~ scale(H) + scale(Temp), data=woodbdnoAMD, REML = FALSE)
...
lmBreak2_avgs[[12]]  <- lm( Breakdown~ scale(Temp) + scale(SRP), data=spongebd, REML = FALSE)
lmBreak2_avgs[[13]]  <- lm( Breakdown~ scale(Temp) + scale(Nitrate), data=spongebd, REML = FALSE)
lmBreak2_avgs[[14]]  <- lm( Breakdown~ scale(Temp) + scale(Ammonium), data=spongebd, REML = FALSE)
lmBreak2_avgs[[15]]  <- lm( Breakdown~ scale(Temp) + scale(Chloride), data=spongebd, REML = FALSE)

lmBreak2_avgs[[16]]  <- lm( Breakdown~ scale(Chloride) + scale(SRP), data=spongebd, REML = FALSE)
lmBreak2_avgs[[17]]  <- lm( Breakdown~ scale(Chloride) + scale(Nitrate), data=spongebd, REML = FALSE)
lmBreak2_avgs[[18]]  <- lm( Breakdown~ scale(Chloride) + scale(Ammonium), data=spongebd, REML = FALSE)

lmBreak2_avgs[[19]]  <- lm( Breakdown~ scale(Nitrate) + scale(SRP), data=spongebd, REML = FALSE)
lmBreak2_avgs[[20]]  <- lm( Breakdown~ scale(Nitrate) + scale(Ammonium), data=spongebd, REML = FALSE)
lmBreak2_avgs[[21]]  <- lm( Breakdown~ scale(SRP) + scale(Ammonium), data=spongebd, REML = FALSE)

lmBreak2_avgs[[22]]  <- lm( Breakdown~ scale(Turbidity) + scale(H), data=spongebd, REML = FALSE)
lmBreak2_avgs[[23]]  <- lm( Breakdown~ scale(Turbidity) + scale(DO), data=spongebd, REML = FALSE)
lmBreak2_avgs[[24]]  <- lm( Breakdown~ scale(Turbidity) + scale(Temp), data=spongebd, REML = FALSE)
lmBreak2_avgs[[25]]  <- lm( Breakdown~ scale(Turbidity) + scale(Chloride), data=spongebd, REML = FALSE)
lmBreak2_avgs[[26]]  <- lm( Breakdown~ scale(Turbidity) + scale(SRP), data=spongebd, REML = FALSE)
lmBreak2_avgs[[27]]  <- lm( Breakdown~ scale(Turbidity) + scale(Nitrate), data=spongebd, REML = FALSE)
lmBreak2_avgs[[28]]  <- lm( Breakdown~ scale(Turbidity) + scale(Ammonium), data=spongebd, REML = FALSE)

lmBreak2_avgs[[29]]  <- lm( Breakdown~ scale(DO) + scale (H), data=spongebd, REML = FALSE)
lmBreak2_avgs[[30]]  <- lm( Breakdown~ scale(DO) + scale(Temp), data=spongebd, REML = FALSE)
lmBreak2_avgs[[31]]  <- lm( Breakdown~ scale(DO) + scale(Chloride), data=spongebd, REML = FALSE)
lmBreak2_avgs[[32]]  <- lm( Breakdown~ scale(DO) + scale(SRP), data=spongebd, REML = FALSE)
lmBreak2_avgs[[33]]  <- lm( Breakdown~ scale(DO) + scale(Nitrate), data=spongebd, REML = FALSE)
lmBreak2_avgs[[34]]  <- lm( Breakdown~ scale(DO) + scale(Ammonium), data=spongebd, REML = FALSE)

lmBreak2_avgs[[35]]  <- lm( Breakdown~ scale(H) + scale(Chloride), data=spongebd, REML = FALSE)
lmBreak2_avgs[[36]]  <- lm( Breakdown~ scale(H) + scale(Nitrate), data=spongebd, REML = FALSE)
lmBreak2_avgs[[37]]  <- lm( Breakdown~ scale(H) + scale(Ammonium), data=spongebd, REML = FALSE)
lmBreak2_avgs[[38]]  <- lm( Breakdown~ scale(H) + scale(SRP), data=spongebd, REML = FALSE)
lmBreak2_avgs[[39]]  <- lm( Breakdown~ scale(H) + scale(Temp), data=spongebd, REML = FALSE)
