...
```{r}
 ...
 mean.resp.wood<-tapply(wooddf$RespRateInd, wooddf$Site, mean)
 mean.resp.sponge
 mean.resp.wood
...
plot(wooddf$H ~ wooddf$Ammonium)
plot(wooddf$RespRateInd ~ wooddf$Ammonium)
plot(wooddf$RespRateInd ~ wooddf$H)
```
...
```{r}
mean.resp.wood<-tapply(wooddf$RespRateInd, wooddf$Site, mean)
mean.break.wood<-tapply(wooddf$Breakdown, wooddf$Site, mean)
...
points(RespRateInd~Chloride, data=wooddf, pch=16)
abline(lm(RespRateInd~Chloride, data=wooddf))

plot(RespRateInd~SRP, data=spongedf)
abline(lm(RespRateInd~SRP, data=spongedf))
points(RespRateInd~SRP, data=wooddf, pch=16)
abline(lm(RespRateInd~SRP, data=wooddf))

plot(RespRateAvg~Breakdown, data=spongedf)
abline(lm(RespRateAvg~Breakdown, data=spongedf))

plot(RespRateAvg~Breakdown, data=wooddf)
abline(lm(RespRateAvg~Breakdown, data=wooddf))
```
